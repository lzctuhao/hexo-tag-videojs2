...
let has_videojs_toast=false;let origin_time;let video_ele,toast_ele;
//长按倍速播放
function LongTab(overlay_ele){
    ...
    toast_ele = overlay_ele.parentElement.getElementsByClassName('toast_text')[0];
    let rate=1;
    addLongtabListener(
        overlay_ele,
        function(){rate=video_ele.playbackRate;video_ele.playbackRate=3},
        function(){video_ele.playbackRate=rate;toast_ele.style.opacity=0;},
        forward
    )
}
