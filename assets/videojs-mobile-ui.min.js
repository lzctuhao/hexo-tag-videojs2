...
function LongTab(overlay_ele){
    ...
    let video_ele = overlay_ele.parentElement.getElementsByTagName('video')[0];
    addLongtabListener(overlay_ele,function(){video_ele.playbackRate=3},function(){video_ele.playbackRate=1})
}
function addLongtabListener(target,callback1,callback2){
